...
public final class ToggleStats extends Table {
  ...
  public io.getunleash.yggdrasil.messaging.VariantEntry variants(int j) {
    return variants(new io.getunleash.yggdrasil.messaging.VariantEntry(), j);
  }

  public io.getunleash.yggdrasil.messaging.VariantEntry variants(
      io.getunleash.yggdrasil.messaging.VariantEntry obj, int j) {
    int o = __offset(8);
  ...
  public io.getunleash.yggdrasil.messaging.VariantEntry.Vector variantsVector() {
    return variantsVector(new io.getunleash.yggdrasil.messaging.VariantEntry.Vector());
  }

  public io.getunleash.yggdrasil.messaging.VariantEntry.Vector variantsVector(
      io.getunleash.yggdrasil.messaging.VariantEntry.Vector obj) {
    int o = __offset(8);
