...
public final class MetricsResponse extends Table {
  ...
  public io.getunleash.yggdrasil.messaging.ToggleEntry toggles(int j) {
    return toggles(new io.getunleash.yggdrasil.messaging.ToggleEntry(), j);
  }

  public io.getunleash.yggdrasil.messaging.ToggleEntry toggles(
      io.getunleash.yggdrasil.messaging.ToggleEntry obj, int j) {
    int o = __offset(8);
  ...
  public io.getunleash.yggdrasil.messaging.ToggleEntry.Vector togglesVector() {
    return togglesVector(new io.getunleash.yggdrasil.messaging.ToggleEntry.Vector());
  }

  public io.getunleash.yggdrasil.messaging.ToggleEntry.Vector togglesVector(
      io.getunleash.yggdrasil.messaging.ToggleEntry.Vector obj) {
    int o = __offset(8);
