...
public final class FeatureDefs extends Table {
  ...
  public io.getunleash.yggdrasil.messaging.FeatureDef items(int j) {
    return items(new io.getunleash.yggdrasil.messaging.FeatureDef(), j);
  }

  public io.getunleash.yggdrasil.messaging.FeatureDef items(
      io.getunleash.yggdrasil.messaging.FeatureDef obj, int j) {
    int o = __offset(4);
  ...
  public io.getunleash.yggdrasil.messaging.FeatureDef.Vector itemsVector() {
    return itemsVector(new io.getunleash.yggdrasil.messaging.FeatureDef.Vector());
  }

  public io.getunleash.yggdrasil.messaging.FeatureDef.Vector itemsVector(
      io.getunleash.yggdrasil.messaging.FeatureDef.Vector obj) {
    int o = __offset(4);
