...
public final class TakeStateResponse extends Table {
  ...
  public io.getunleash.yggdrasil.messaging.StrategyFeature features(int j) {
    return features(new io.getunleash.yggdrasil.messaging.StrategyFeature(), j);
  }

  public io.getunleash.yggdrasil.messaging.StrategyFeature features(
      io.getunleash.yggdrasil.messaging.StrategyFeature obj, int j) {
    int o = __offset(4);
  ...
  public io.getunleash.yggdrasil.messaging.StrategyFeature.Vector featuresVector() {
    return featuresVector(new io.getunleash.yggdrasil.messaging.StrategyFeature.Vector());
  }

  public io.getunleash.yggdrasil.messaging.StrategyFeature.Vector featuresVector(
      io.getunleash.yggdrasil.messaging.StrategyFeature.Vector obj) {
    int o = __offset(4);
