...
public final class FeatureDefs extends Table {
  ...
  public io.getunleash.messaging.FeatureDef items(int j) {
    return items(new io.getunleash.messaging.FeatureDef(), j);
  }

  public io.getunleash.messaging.FeatureDef items(io.getunleash.messaging.FeatureDef obj, int j) {
    int o = __offset(4);
  ...
  public io.getunleash.messaging.FeatureDef.Vector itemsVector() {
    return itemsVector(new io.getunleash.messaging.FeatureDef.Vector());
  }

  public io.getunleash.messaging.FeatureDef.Vector itemsVector(
      io.getunleash.messaging.FeatureDef.Vector obj) {
    int o = __offset(4);
