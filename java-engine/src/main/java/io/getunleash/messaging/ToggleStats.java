...
public final class ToggleStats extends Table {
  ...
  public io.getunleash.messaging.VariantEntry variants(int j) {
    return variants(new io.getunleash.messaging.VariantEntry(), j);
  }

  public io.getunleash.messaging.VariantEntry variants(
      io.getunleash.messaging.VariantEntry obj, int j) {
    int o = __offset(8);
  ...
  public io.getunleash.messaging.VariantEntry.Vector variantsVector() {
    return variantsVector(new io.getunleash.messaging.VariantEntry.Vector());
  }

  public io.getunleash.messaging.VariantEntry.Vector variantsVector(
      io.getunleash.messaging.VariantEntry.Vector obj) {
    int o = __offset(8);
