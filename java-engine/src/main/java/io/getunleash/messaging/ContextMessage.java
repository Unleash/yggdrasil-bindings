...
public final class ContextMessage extends Table {
  ...
  public io.getunleash.messaging.PropertyEntry properties(int j) { return properties(new io.getunleash.messaging.PropertyEntry(), j); }
  public io.getunleash.messaging.PropertyEntry properties(io.getunleash.messaging.PropertyEntry obj, int j) { int o = __offset(20); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int propertiesLength() { int o = __offset(20); return o != 0 ? __vector_len(o) : 0; }
  public io.getunleash.messaging.PropertyEntry propertiesByKey(String key) { int o = __offset(20); return o != 0 ? io.getunleash.messaging.PropertyEntry.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public io.getunleash.messaging.PropertyEntry propertiesByKey(io.getunleash.messaging.PropertyEntry obj, String key) { int o = __offset(20); return o != 0 ? io.getunleash.messaging.PropertyEntry.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public io.getunleash.messaging.PropertyEntry.Vector propertiesVector() { return propertiesVector(new io.getunleash.messaging.PropertyEntry.Vector()); }
  public io.getunleash.messaging.PropertyEntry.Vector propertiesVector(io.getunleash.messaging.PropertyEntry.Vector obj) { int o = __offset(20); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public io.getunleash.messaging.CustomStrategyResult customStrategiesResults(int j) { return customStrategiesResults(new io.getunleash.messaging.CustomStrategyResult(), j); }
  public io.getunleash.messaging.CustomStrategyResult customStrategiesResults(io.getunleash.messaging.CustomStrategyResult obj, int j) { int o = __offset(22); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int customStrategiesResultsLength() { int o = __offset(22); return o != 0 ? __vector_len(o) : 0; }
  public io.getunleash.messaging.CustomStrategyResult customStrategiesResultsByKey(String key) { int o = __offset(22); return o != 0 ? io.getunleash.messaging.CustomStrategyResult.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public io.getunleash.messaging.CustomStrategyResult customStrategiesResultsByKey(io.getunleash.messaging.CustomStrategyResult obj, String key) { int o = __offset(22); return o != 0 ? io.getunleash.messaging.CustomStrategyResult.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public io.getunleash.messaging.CustomStrategyResult.Vector customStrategiesResultsVector() { return customStrategiesResultsVector(new io.getunleash.messaging.CustomStrategyResult.Vector()); }
  public io.getunleash.messaging.CustomStrategyResult.Vector customStrategiesResultsVector(io.getunleash.messaging.CustomStrategyResult.Vector obj) { int o = __offset(22); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
