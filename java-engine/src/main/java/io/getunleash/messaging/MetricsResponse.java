...
public final class MetricsResponse extends Table {
  ...
  public io.getunleash.messaging.ToggleEntry toggles(int j) {
    return toggles(new io.getunleash.messaging.ToggleEntry(), j);
  }

  public io.getunleash.messaging.ToggleEntry toggles(
      io.getunleash.messaging.ToggleEntry obj, int j) {
    int o = __offset(8);
  ...
  public io.getunleash.messaging.ToggleEntry.Vector togglesVector() {
    return togglesVector(new io.getunleash.messaging.ToggleEntry.Vector());
  }

  public io.getunleash.messaging.ToggleEntry.Vector togglesVector(
      io.getunleash.messaging.ToggleEntry.Vector obj) {
    int o = __offset(8);
