...
public final class Variant extends Table {
  ...
  public io.getunleash.messaging.VariantPayload payload() {
    return payload(new io.getunleash.messaging.VariantPayload());
  }

  public io.getunleash.messaging.VariantPayload payload(
      io.getunleash.messaging.VariantPayload obj) {
    int o = __offset(12);
