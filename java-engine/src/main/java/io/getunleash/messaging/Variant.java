...
public final class Variant extends Table {
  ...
  public io.getunleash.messaging.VariantPayload payload() { return payload(new io.getunleash.messaging.VariantPayload()); }
  public io.getunleash.messaging.VariantPayload payload(io.getunleash.messaging.VariantPayload obj) { int o = __offset(12); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
